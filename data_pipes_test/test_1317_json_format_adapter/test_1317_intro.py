...
class Case1314DP_filenames_must_look_a_way(_CommonCase):
    ...
    def given(self):
        ...
        return {
                ...
                'producer_script': executable_fixture('chimi-churry.py'),
                }
...
class Case1315_file_not_found(_CommonCase):
    ...
    def given(self):
        return {
                'near_collection': _same_near_collection(),
                'producer_script': 'script/no_such_script_one.py',
                }
...
class Case1319DP_bad_human_key(_CommonCase):
    ...
    def given(self):
        return {
                'near_collection': _same_near_collection(),
                'producer_script': _chimi_churri_far_path()
                }
...
class Case1322DP_RUM(_CommonCase):
    ...
    def given(self):
        return {
                ...
                'producer_script': executable_fixture('exe_120_endcap_yes_no.py'),  # noqa: E501
                }
