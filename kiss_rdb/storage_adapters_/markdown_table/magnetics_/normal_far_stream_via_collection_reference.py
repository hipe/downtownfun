...
def OPEN_NEAR_SESSION(
    ...
    if keyerer is None:
        ...
        cover_me("this was the old way, mabye it will be the new way")  # noqa: E501 #todo
        keyerer = _procure_func_via_func_identifier(keyerer, listener)  # noqa: E501
        if keyerer is None:
...
def FAR_STREAM_FOR_SYNC_VIA(
    ...
    """
    👉 see this [#423.B] a graph-viz graph about pipelines
    ...
    # dead #provision [#458.J] at #history-A.2 #todo
...
# #history-A.2: no more sync-side stream mapping, traversal_parameters_version
